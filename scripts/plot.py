...
ALTERNATIVE_METRICS: List[Tuple[str, str]] = [
    ...
    ("js_divergence_new", "JS divergence (new task)"),
    ("js_divergence_old", "JS divergence (old task)"),
    ("wasserstein_l1_new", "Wasserstein-1 (new task)"),
    ("wasserstein_l1_old", "Wasserstein-1 (old task)"),
